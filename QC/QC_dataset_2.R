...
library(corrplot)
data <- Read10X_h5("/nfs/scistore18/vicosgrp/melkrewi/Project_snRNA_ovaries_with_W/3.replicate_2/cellbender/output_FPR_0.5_filtered.h5", use.names = TRUE)
...
write.csv(export_df, "seurat_clusters_dataset_2_round2_no_DB_removal.txt")
dev.off()
...
write.csv(export_df, "seurat_clusters_dataset_2_round2.txt")
saveRDS(data.filt, "replicate_2.rds")
