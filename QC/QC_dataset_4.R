...
library(corrplot)
data <- Read10X_h5("/nfs/scistore18/vicosgrp/melkrewi/Project_snRNA_ovaries_with_W/5.replicate_4/cellbender/round2/round3/round4/output_FPR_0.25_filtered.h5", use.names = TRUE)
...
write.csv(export_df, "seurat_clusters_dataset_4_round2_no_DB_removal.txt")
